...
//     @Inject(MAT_DIALOG_DATA) public data: any, private refreshService: FindingsRefreshService
//   ) {
//     this.createForm();
//     this.fetchAuditors();
//     this.fetchSuppliers();
...
//   // onSupplierChange(supplier: any): void {
//   //   this.selectedSupplier = supplier;
//   //   this.scheduleForm.patchValue({ supplier: supplier.companyId });
//   //   this.closeAllDropdowns();
//   // }

//   // onAuditorChange(auditor: any): void {
//   //   this.selectedAuditor = auditor;
//   //   this.scheduleForm.patchValue({ auditor: auditor.auditorId });
//   //   this.closeAllDropdowns();
//   // }

//   // onAuditTypeChange(auditType: any): void {
//   //   this.selectedAuditType = auditType;
//   //   this.scheduleForm.patchValue({ auditType: auditType.auditTypeId });
//   //   this.closeAllDropdowns();
//   // }
...
export class Scheduleauditscomponent {
  ...
  onSubmit(): void {
    ...
    if(!this.istimevalid){
      this.notify.Error('Please select correct Time.');
      return;
    }
  ...
  if (isToday && selectedDateTime < today) {
    this.istimevalid = false;
    this.scheduleForm.get('time')?.setValue(null);
